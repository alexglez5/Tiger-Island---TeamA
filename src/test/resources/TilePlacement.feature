Feature: Tile Placement
  ...
  Scenario: First tile placement hexes exist
    Given the board is empty and player is given tile with terrains "LAKE" and "ROCK"
    ...
    And the tile right hex should be placed at (0,1) with terrain "ROCK"
  ...
  Scenario: It is the start of a player's turns on turn 2
    Given the player is given a tile with terrains "LAKE" and "ROCK"
