...
public class SettlementTest {
    ...
    @Before
    public void setup() {
        s = new Settlement(new Coordinate(0,0,0));
    }

    @Test
    public void shouldAddCoordinateToSettlement() {
        s.addToSettlement(new Coordinate(0,1,-1));
        Assert.assertTrue(s.contains(new Coordinate(0,1,-1)));
    ...
    public void shouldRemoveCoordinateFromSettlement() {
        s.addToSettlement(new Coordinate(0,1,-1));
        s.removeFromSettlement(new Coordinate(0,0,0));
        Assert.assertFalse(s.contains(new Coordinate( 0,0,0)));
