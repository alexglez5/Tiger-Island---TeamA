...
public class BuildWithPointsAndPiecesTest {
    ...
    public void foundSettlementAndCheckPlayerScoreAndVillagerUpdated(){
        ...
        Assert.assertEquals(map.gameBoard.get(new Coordinate(0,1)).getWhichPlayerID(),1);
    }
    ...
    public void MergeSettlementTest(){
        ...
        Assert.assertEquals(map.gameBoard.get(new Coordinate(-1,1)).getWhichPlayerID(),map.gameBoard.get(new Coordinate(0,1)).getWhichPlayerID());
    }
    ...
    public void testSettlementsAreNotMergedWhenDifferentPlayerIDs() throws Exception{
        ...
        map.placeTile(new Tile(TerrainType.Jungle, TerrainType.Rocky),
                new Coordinate(-2,2), Orientation.FromBottom);
        map.foundNewSettlement(new Coordinate(1,1));
        //System.out.println("Player ID: " + map.gameBoard.get(new Coordinate(1,1)).getWhichPlayerID());
        ...
        System.out.println("Player ID: " + map.gameBoard.get(new Coordinate(1,1)).getWhichPlayerID());
        System.out.println("Player ID: " + map.gameBoard.get(new Coordinate(-2,3)).getWhichPlayerID());
        Assert.assertTrue(map.gameBoard.get(new Coordinate( -2,3)).getWhichPlayerID() !=
                map.gameBoard.get(new Coordinate(1,1)).getWhichPlayerID());
        ...
        //System.out.println("Settlement ID: " + map.gameBoard.get(new Coordinate(0,2)).getSettlementID());
        Assert.assertEquals(map.gameBoard.get(new Coordinate(1,1)).getWhichPlayerID(), 4);
        //System.out.println("Player ID: " + map.gameBoard.get(new Coordinate(0,2)).getWhichPlayerID());
        Assert.assertEquals(map.gameBoard.get(new Coordinate(0,2)).getWhichPlayerID(), 5);
        Assert.assertTrue(map.gameBoard.get(new Coordinate(1,1)).getWhichPlayerID() !=
                map.gameBoard.get(new Coordinate(0,2)).getWhichPlayerID());
        Assert.assertTrue(map.gameBoard.get(new Coordinate(-2,3)).getWhichPlayerID() ==
                map.gameBoard.get(new Coordinate(0,2)).getWhichPlayerID());
        ...
        Assert.assertEquals(map.gameBoard.get(new Coordinate( -2,3)).getSettlementID(),
                map.gameBoard.get(new Coordinate(0 ,2)).getSettlementID());
        int newId = map.gameBoard.get(new Coordinate(0 ,2)).getSettlementID();
        int oldId = map.gameBoard.get(new Coordinate(1 ,1)).getSettlementID();
        //Assert.assertNotEquals(oldId, newId);
        Assert.assertEquals(map.settlements.get(newId).settlementCoordinates.size(), 6);
        Assert.assertEquals(map.settlements.get(oldId).settlementCoordinates.size(), 1);
    }
