...
public class AIHelperTest{
    ...
    public void initializeGameBoard() throws Exception {
        map = new Game();
        helper = new AIHelper();
        helper.updtateComponents(map.getComponents());
    ...
    public void shouldReturnArrayListOfCoordinatesWhereTigerCanBePlaced() throws Exception {
        ...
        map.getSettlements().put(3, new Settlement(new Coordinate(-1,1)));
        map.getSettlements().get(3).addToSettlement(new Coordinate(-1,1));
